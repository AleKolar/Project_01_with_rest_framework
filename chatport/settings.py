"""
Django settings for chatport project.
...
SECRET_KEY = 'django-insecure-y7%@rje5g@7zxd^1%*5o5evo=^)6-g_9qg_^d15rp5z!-glle='
...
WSGI_APPLICATION = 'chatport.wsgi.application'
